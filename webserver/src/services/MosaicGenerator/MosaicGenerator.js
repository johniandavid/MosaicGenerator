...
var index_1 = require("../../../libraries/mosaic-node-generator/index");
var fs = require('fs');
...
var MosaicGenerator = /** @class */ (function () {
    ...
    MosaicGenerator.prototype._sleep = function (ms) {
    ...
    MosaicGenerator.prototype.generate = function () {
        ...
        this._sleep(10000)
            .then(function () {
            index_1.mosaic(_this.filePath, './input/tilesDirectory').then(function (res) {
...
app.get("/", function (req, res) {
    ...
    res.send(_this.outputImageName);
});
